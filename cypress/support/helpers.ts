export const checkIdHasText = (
  ...
  export const assertURLContains = (
  ...
  export const enterDate = (
    ...
    cy.get(`[name="response[day]`)
      .should('exist')
      .type(dateArray[0])
      cy.get(`[name="response[month]`)
      .should('exist')
      .type(dateArray[1])
      cy.get(`[name="response[year]`)
      .should('exist')
      .type(dateArray[2])
